...
AWS_ACCESS_KEY_ID = os.environ.get('DS_AWS_ACCESS_KEY')
AWS_SECRET_ACCESS_KEY = os.environ.get('DS_SECRET_KEY')
AWS_STORAGE_BUCKET_NAME = os.environ.get('DS_AWS_BUCKET')
